...
import { Card, CardContent, CardHeader, CardTitle, Input, Button, Alert, Badge } from '@/components/ui'
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">Manage your farmer profile information</p>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                <option value="fpo">Farmers Producer Organization (FPO)</option>
              </select>
            </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600">Your account verification status</p>
              <p className="text-sm text-gray-500 mt-1">
                Verified farmers get priority in marketplace listings
              </p>
            </div>
